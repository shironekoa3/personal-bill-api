package com.example.personalbillapi.config;
...
public class DatabaseInitialize {
    ...
    private void runSQLScript(String path, boolean isClasspath, Connection connection) {
        try (InputStream sqlFileStream = isClasspath ? new ClassPathResource(path).getInputStream() : Files.newInputStream(Paths.get(path))) {
